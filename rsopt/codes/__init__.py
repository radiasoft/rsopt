import pydantic
import typing
from rsopt.codes import spiffe, elegant, python, opal, madx, flash
...
SUPPORTED_CODES = typing.Union[elegant.Elegant, flash.Flash, madx.Madx, opal.Opal,  python.Python, spiffe.Spiffe]
