...
class NloptOptimizer(optimizer.libEnsembleOptimizer):
    ...
    def _configure_optimizer(self):
        ...
        user_keys = {'lb': self._config.lower_bounds,
                     ...
                     # Tolerances default to None and should not be passed if not set, or libE will try to use them
                     **self._config.options.software_options.model_dump(exclude_none=True)
                     }
