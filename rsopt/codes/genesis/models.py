...
class Integer19StringArray(Enum):
    RADIATION_POWER = 1
...
class io(BaseModel):
    ...
    filetype: str = Field("ORIGINAL", description="FILETYPE: Indication of the file type of all output files. ")
    ...
    lout: Integer19StringArray = Field(default_factory=Integer19StringArray.values_as_string, description="Defines, which parameter is included in the main output file.")
